  ...
  <div id="hero" data-section="hero">
      ...
      mediaItems={[
        ...
        },
        {
          ...
          imageAlt: "Precision Plumbing",
        },
        {
          imageSrc: "http://img.b2bpic.net/free-photo/white-bathroom-wall-background-with-towel-rack_53876-145203.jpg",
  ...
  <div id="services" data-section="services">
      ...
      products={[
        ...
        },
        {
          ...
          price: "Get Quote",
          imageSrc: "http://img.b2bpic.net/free-photo/3d-geometric-abstract-background_1048-13139.jpg",
        },
      ]}
      ...
      metrics={[
        {
          id: "p1",
          value: "1.",
          description: "Get in Touch via call or form.",
        },
        {
          id: "p2",
          value: "2.",
          description: "Fast Assessment and diagnosis.",
        },
        {
          id: "p3",
          value: "3.",
          description: "Upfront, honest pricing.",
        },
        {
          id: "p4",
          value: "4.",
          description: "Flawless, clean execution.",
        },
      ]}
  ...
  <div id="standards" data-section="standards">
      ...
      testimonials={[
        ...
        },
        {
          ...
          company: "Northgate",
          rating: 5,
          imageSrc: "http://img.b2bpic.net/free-photo/closeup-shot-stainless-silver-water-tap_181624-48218.jpg",
        },
        {
          id: "t4",
          name: "David Chen",
  ...
  <div id="area" data-section="area">
      ...
      faqs={[
        ...
        },
        {
          ...
          content: "Same-day appointments are available for all urgent repairs.",
        },
        {
          id: "f3",
          title: "Insurance",
          content: "Every technician is fully insured and certified for your peace of mind.",
        },
        {
          id: "f4",
          title: "Emergency Availability",
          content: "24/7 emergency support is available for burst pipes and urgent leaks.",
        },
        {
          id: "f5",
          title: "Quality Guarantee",
          content: "All repairs come with our signature 'first-time fixed' performance guarantee.",
        },
      ]}
